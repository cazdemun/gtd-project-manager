...
// Config constants
export const CONFIG_SHOW_FILTER_BAR_PERIODIC_PAGE = 'CONFIG_SHOW_FILTER_BAR_PERIODIC_PAGE';
export const CONFIG_PERIODICS_PAGE_FILTER = 'CONFIG_PERIODICS_PAGE_FILTER';
export const CONFIG_SHOW_PAST_PROJECTS = 'CONFIG_SHOW_PAST_PROJECTS';

export const CONFIG_SHOW_FILTER_BAR_TABBED_PANEL = 'CONFIG_SHOW_FILTER_BAR_TABBED_PANEL';
export const CONFIG_SHOW_PROJECTS_PANEL = 'CONFIG_SHOW_PROJECTS_PANEL';
export const CONFIG_SELECTED_TAB = 'CONFIG_SELECTED_TAB';

export const CONFIG_TAG_COLORS = 'CONFIG_TAG_COLORS';